...
class _LaneNetCluster(object):
    ...
    def apply_lane_feats_cluster(self, binary_seg_result, instance_seg_result):
        ...
        mask = np.zeros(
            shape=[binary_seg_result.shape[0], binary_seg_result.shape[1]],
            dtype=np.int32,
        )
...
class LaneNetPostProcessor(object):
    ...
    def postprocess(
        self, binary_seg_result, instance_seg_result=None, min_area_threshold=100
    ):
        """
        ...
        mask_image, lane_coords = self._cluster.apply_lane_feats_cluster(
            binary_seg_result=morphological_ret, instance_seg_result=instance_seg_result
        )
